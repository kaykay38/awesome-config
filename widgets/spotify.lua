...
local function worker(user_args)
    ...
    local play_icon = args.play_icon or '/usr/share/icons/Papirus/24x24/panel/spotify-green-indicator.svg'
    local pause_icon = args.pause_icon or '/usr/share/icons/Papirus/24x24/panel/spotify-indicator.svg'
    ...
    spotify_widget:connect_signal("button::press", function(_, _, _, button)
        ...
        elseif (button == 3) then
            awful.spawn("spotify-cover", false)      -- right click
