...
local ICON_DIR = HOME .. '/.config/awesome/icons/awesomewm/'
...
local programs_list = { }
awful.spawn.with_line_callback([[bash -c 'find $HOME/.local/share/applications /usr/share/applications /usr/local/share/applications -type f -name "*.desktop"']], {
...
local app_drawer_widget = wibox.widget {
    {
        {
            image = ICON_DIR .. 'awesome32gray.png',
            resize = true,
